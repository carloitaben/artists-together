...
export default function ProfileTab({ section }: { section: Section }) {
  ...
  return (
    <Anchor
      href={`#${section}`}
      className="flex h-12 items-center gap-x-2 rounded-4 bg-gunpla-white-50 px-3 text-gunpla-white-500 transition-transform active:scale-95 disabled:active:scale-100"
    >
