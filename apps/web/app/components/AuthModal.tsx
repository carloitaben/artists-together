...
export default function AuthModal({ className, children }: Props) {
  ...
  return (
    <Modal.Root>
      ...
      <Modal.Portal>
        <Modal.Overlay />
        <Modal.Content className="fixed flex items-center justify-center inset-0">
          <div className=" bg-gunpla-white-50">
            <Modal.Title>Login or sign up</Modal.Title>
            <div>
              <strong>log in</strong>
              <loginFetcher.Form action={$path("/auth/login")} method="post">
                <input
                  type="email"
                  name="email"
                  placeholder="email"
            ...
            <div>
              ...
              <signupFetcher.Form action={$path("/auth/register")} method="post">
                <input
                  type="email"
                  name="email"
                  placeholder="email"
            ...
            <div>
              ...
              <magicFetcher.Form action={$path("/auth/magic")} method="post">
                <input
                  type="text"
                  name="email"
                  placeholder="email"
